          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
              <td align="left" valign="middle" style="font-size:18px;font-weight:800;color:${T.text};letter-spacing:-0.3px;line-height:1;">
                <!-- Logo image (loads when remote content allowed). Wordmark
                     remains as text fallback for clients that block images. -->
                <img src="https://overowned.io/logo.png"
                     alt="OverOwned"
                     width="28" height="28"
                     style="display:inline-block;vertical-align:middle;margin-right:10px;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" />
                <span style="vertical-align:middle;">Over<span style="color:${T.gold};">O</span>wned</span>
              </td>
